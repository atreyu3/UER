...
<div class="transaccionrefaccion-form">
	...
	<?= $form->field($model, 'tbl_item_id_item')->textInput(['readOnly' =>true])->label('FOLIO ITEM DIRECTO')  ?>
	
    <!--<? $form->field($model, 'mod_transaccionrefaccion_date')->widget(kartik\date\DatePicker::classname(), [
    //'language' => 'ru',
