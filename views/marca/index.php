...
?>
<div class="marca-index col-lg-12 col-md-12 col-xs-12 well">
    ...
    <p>
        <?= ButtonGroup::widget([
        'buttons'=>[
        Html::a(Yii::t('app', 'Create Marca'), ['create'], ['class' => 'btn btn-raised btn-success opcion','data-toggle'=>'modal','data-target'=>'#marca-modal']), 
        ...
        'linkTemplate' => '<a href="{url}" class="opcion" data-toggle="modal" data-target="#marca-modal" ><span>{label}</span></a>',
