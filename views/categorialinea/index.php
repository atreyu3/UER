...
/* @var $searchModel app\models\CategorialineaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Categorialineas');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="categorialinea-index col-lg-12 col-md-12 col-xs-12 well">
    ...
    <p>
        <?= ButtonGroup::widget([
        'buttons'=>[
        Html::a(Yii::t('app', 'Create Categorialinea'), ['create'], ['class' => 'btn btn-raised btn-success opcion','data-toggle'=>'modal','data-target'=>'#categorialinea-modal']), 
        ...
        'linkTemplate' => '<a href="{url}" class="opcion" data-toggle="modal" data-target="#categorialinea-modal" ><span>{label}</span></a>',
		...
		'buttons'=>[
		  'update'=>function ($url, $model) {
		  	return Html::a('<span class="glyphicon glyphicon-edit "></span>', $url, [
                                        ...
                                        'class'=>'opcion',
                                        'data-target'=>'#categorialinea-modal',
                                        'data-toggle'=>'modal'
				]);
		  	}
		  ]		
...
<?php	Modal::begin([
			 'id'=>'categorialinea-modal',
			 'size'=>'modal-lg'
	]);
 ?>
 <div id="categorialinea-modal-form"></div>
 <?php Modal::end(); ?>
</div>
