...
/* @var $searchModel app\models\CatfamiliaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Catfamilias');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="catfamilia-index col-lg-12 col-md-12 col-xs-12 well">
    ...
    <p>
        <?= ButtonGroup::widget([
        'buttons'=>[
        Html::a(Yii::t('app', 'Create Catfamilia'), ['create'], ['class' => 'btn btn-raised btn-success opcion','data-toggle'=>'modal','data-target'=>'#catfamilia-modal']), 
        ...
        'linkTemplate' => '<a href="{url}" class="opcion" data-toggle="modal" data-target="#catfamilia-modal" ><span>{label}</span></a>',
...
<?php	Modal::begin([
 ...
 ?>
 <div id="catfamilia-modal-form"></div>
 <?php Modal::end(); ?>
</div>
