...
?>
<div class="proveedor-index col-lg-12 col-md-12 col-xs-12 well">
    ...
    <p>
        <?= ButtonGroup::widget([
        'buttons'=>[
        Html::a(Yii::t('app', 'Create Proveedor'), ['create'], ['class' => 'btn btn-raised btn-success opcion','data-toggle'=>'modal','data-target'=>'#proveedor-modal']), 
        ...
        'linkTemplate' => '<a href="{url}" class="opcion" data-toggle="modal" data-target="#proveedor-modal" ><span>{label}</span></a>',
...
<?php	Modal::begin([
 ...
 ?>
 <div id="proveedor-modal-form"></div>
 <?php Modal::end(); ?>
</div>
