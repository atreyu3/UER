...
/* @var $searchModel app\models\RequisicionesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Requisiciones');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="requisiciones-index col-lg-12 col-md-12 col-xs-12 well">
    ...
    <p>
        <?= ButtonGroup::widget([
        'buttons'=>[
        Html::a(Yii::t('app', 'Create Requisiciones'), ['create'], ['class' => 'btn btn-raised btn-success opcion','data-toggle'=>'modal','data-target'=>'#requisiciones-modal']), 
        ...
        'linkTemplate' => '<a href="{url}" class="opcion" data-toggle="modal" data-target="#requisiciones-modal" ><span>{label}</span></a>',
		...
		'buttons'=>[
		  'update'=>function ($url, $model) {
		  	return Html::a('<span class="glyphicon glyphicon-edit "></span>', $url, [
                                        ...
                                        'class'=>'opcion',
                                        'data-target'=>'#requisiciones-modal',
                                        'data-toggle'=>'modal'
				]);
		  	}
		  ]		
...
<?php	Modal::begin([
			 'id'=>'requisiciones-modal',
			 'size'=>'modal-lg'
	]);
 ?>
 <div id="requisiciones-modal-form"></div>
 <?php Modal::end(); ?>
</div>
