...
/* @var $searchModel app\models\HistorialmaquinaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Historialmaquinas');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="historialmaquina-index col-lg-12 col-md-12 col-xs-12 well">
    ...
    <p>
        <?= ButtonGroup::widget([
        'buttons'=>[
        Html::a(Yii::t('app', 'Create Historialmaquina'), ['create'], ['class' => 'btn btn-raised btn-success opcion','data-toggle'=>'modal','data-target'=>'#historialmaquina-modal']), 
        ...
        'linkTemplate' => '<a href="{url}" class="opcion" data-toggle="modal" data-target="#historialmaquina-modal" ><span>{label}</span></a>',
	...
	['class' => 'kartik\grid\SerialColumn'],
            ...
            'tbl_historialmaquina_usuario',
				[ 
					...
					'filter'=>Html::activeDropDownList($searchModel,'tbl_maquina_id_maquina',$model->tblmaquinaList,['class'=>'form-control','prompt' => 'Select Category']), 
					'group'=>true 
				],
		...
		'buttons'=>[
		  'update'=>function ($url, $model) {
		  	return Html::a('<span class="glyphicon glyphicon-edit "></span>', $url, [
                                        ...
                                        'class'=>'opcion',
                                        'data-target'=>'#historialmaquina-modal',
                                        'data-toggle'=>'modal'
				]);
		  	}
		  ]		
...
<?php	Modal::begin([
			 'id'=>'historialmaquina-modal',
			 'size'=>'modal-lg'
	]);
 ?>
 <div id="historialmaquina-modal-form"></div>
 <?php Modal::end(); ?>
</div>
