...
/* @var $searchModel app\models\UbicacionfisicaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Ubicacionfisicas');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="ubicacionfisica-index col-lg-12 col-md-12 col-xs-12 well">
    ...
    <p>
        <?= ButtonGroup::widget([
        'buttons'=>[
        Html::a(Yii::t('app', 'Create Ubicacionfisica'), ['create'], ['class' => 'btn btn-raised btn-success opcion','data-toggle'=>'modal','data-target'=>'#ubicacionfisica-modal']), 
        ...
        'linkTemplate' => '<a href="{url}" class="opcion" data-toggle="modal" data-target="#ubicacionfisica-modal" ><span>{label}</span></a>',
		...
		'buttons'=>[
		  'update'=>function ($url, $model) {
		  	return Html::a('<span class="glyphicon glyphicon-edit "></span>', $url, [
                                        ...
                                        'class'=>'opcion',
                                        'data-target'=>'#ubicacionfisica-modal',
                                        'data-toggle'=>'modal'
				]);
		  	}
		  ]		
...
<?php	Modal::begin([
			 'id'=>'ubicacionfisica-modal',
			 'size'=>'modal-lg'
	]);
 ?>
 <div id="ubicacionfisica-modal-form"></div>
 <?php Modal::end(); ?>
</div>
