...
<div class="ubicacionfisica-form">

    <?php $form = ActiveForm::begin([
   	'id'=>$model->formName(),
    ]); ?>
    
    <?= $form->field($model, 'tbl_ubicacionfisica_nombre')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'tbl_ubicacionfisica_planta')->textInput() ?>
