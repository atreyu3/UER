...
?>
<div class="read-index col-lg-12 col-md-12 col-xs-12 well">
    ...
    <p>
        <?= ButtonGroup::widget([
        'buttons'=>[
        Html::a(Yii::t('app', 'Create Read'), ['create'], ['class' => 'btn btn-raised btn-success opcion','data-toggle'=>'modal','data-target'=>'#read-modal']), 
        ...
        'linkTemplate' => '<a href="{url}" class="opcion" data-toggle="modal" data-target="#read-modal" ><span>{label}</span></a>',
	...
	['class' => 'kartik\grid\SerialColumn'],
            ...
            'tbl_read_rssi',
				[ 
			   		'attribute'=>'tbl_readusuario_id_readusuario', 
					'value'=>'tblReadusuarioIdReadusuario.tbl_readusuario_tagid', 
					'filter'=>Html::activeDropDownList($searchModel,'tbl_readusuario_id_readusuario',$model->tblreadusuarioList,['class'=>'form-control','prompt' => 'Select Category']), 
					'group'=>true 
				],
