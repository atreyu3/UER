...
/* @var $searchModel app\models\CentrodecostosSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Centrodecostos');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="centrodecostos-index col-lg-12 col-md-12 col-xs-12 well">
    ...
    <p>
        <?= ButtonGroup::widget([
        'buttons'=>[
        Html::a(Yii::t('app', 'Create Centrodecostos'), ['create'], ['class' => 'btn btn-raised btn-success opcion','data-toggle'=>'modal','data-target'=>'#centrodecostos-modal']), 
        ...
        'linkTemplate' => '<a href="{url}" class="opcion" data-toggle="modal" data-target="#centrodecostos-modal" ><span>{label}</span></a>',
		...
		'buttons'=>[
		  'update'=>function ($url, $model) {
		  	return Html::a('<span class="glyphicon glyphicon-edit "></span>', $url, [
                                        ...
                                        'class'=>'opcion',
                                        'data-target'=>'#centrodecostos-modal',
                                        'data-toggle'=>'modal'
				]);
		  	}
		  ]		
...
<?php	Modal::begin([
			 'id'=>'centrodecostos-modal',
			 'size'=>'modal-lg'
	]);
 ?>
 <div id="centrodecostos-modal-form"></div>
 <?php Modal::end(); ?>
</div>
