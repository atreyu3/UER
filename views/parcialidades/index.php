...
/* @var $searchModel app\models\ParcialidadesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Parcialidades');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="parcialidades-index col-lg-12 col-md-12 col-xs-12 well">
    ...
    <p>
        <?= ButtonGroup::widget([
        'buttons'=>[
        Html::a(Yii::t('app', 'Create Parcialidades'), ['create'], ['class' => 'btn btn-raised btn-success opcion','data-toggle'=>'modal','data-target'=>'#parcialidades-modal']), 
        ...
        'linkTemplate' => '<a href="{url}" class="opcion" data-toggle="modal" data-target="#parcialidades-modal" ><span>{label}</span></a>',
		...
		'buttons'=>[
		  'update'=>function ($url, $model) {
		  	return Html::a('<span class="glyphicon glyphicon-edit "></span>', $url, [
                                        ...
                                        'class'=>'opcion',
                                        'data-target'=>'#parcialidades-modal',
                                        'data-toggle'=>'modal'
				]);
		  	}
		  ]		
...
<?php	Modal::begin([
			 'id'=>'parcialidades-modal',
			 'size'=>'modal-lg'
	]);
 ?>
 <div id="parcialidades-modal-form"></div>
 <?php Modal::end(); ?>
</div>
