...
use app\models\CategoriauserSearch;
...
use app\models\User;
/**
 * CategoriauserController implements the CRUD actions for Categoriauser model.
 */
class CategoriauserController extends Controller
{
    ...
    /**
     * Lists all Categoriauser models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new CategoriauserSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->post());
		$model=new Categoriauser();
    ...
    /**
     * Displays a single Categoriauser model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Categoriauser model.
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id_categoriauser]);
        } else {
    ...
    /**
     * Updates an existing Categoriauser model.
    ...
    /**
     * Deletes an existing Categoriauser model.
    ...
    /**
     * Finds the Categoriauser model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Categoriauser the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Categoriauser::findOne($id)) !== null) {
            return $model;
        } else {
