...
use app\models\CatfamiliaSearch;
...
use app\models\User;
/**
 * CatfamiliaController implements the CRUD actions for Catfamilia model.
 */
class CatfamiliaController extends Controller
{
    ...
    /**
     * Lists all Catfamilia models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new CatfamiliaSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
		$model=new Catfamilia();
    ...
    /**
     * Displays a single Catfamilia model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Catfamilia model.
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id_catfamilia]);
        } else {
    ...
    /**
     * Updates an existing Catfamilia model.
    ...
    /**
     * Deletes an existing Catfamilia model.
    ...
    /**
     * Finds the Catfamilia model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Catfamilia the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Catfamilia::findOne($id)) !== null) {
            return $model;
        } else {
